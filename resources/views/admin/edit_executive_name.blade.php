                        ...
                        <div class="col-lg-12">
                            <div class="card"> 
                                ...
                                <div class="card-header pb-0">
                                    <div class="row">
                                    <div class="col-sm-12">
                                    <h5>Edit Executive Name details</h5>
                                    </div>
                                    </div>                                    
                                </div>
                                    ...
                                    <form class="row gx-3" id="editlocation">
                                        <div class="form-group col-md-6 col-sm-6">
                                            <label>Location Name<span class="font-danger">*</span></label>
                                                <input type="text" name="name" class="form-control" value="<?php echo $executive_name->name; ?>" required="">
                                            <input type="hidden" name="catid" class="form-control" value="<?php echo $executive_name->id; ?>">
                                        </div>
                                    <div class="form-btn">
...
$.ajax({
type: 'POST',
url: '{{url("/api/editexecutive_namenow")}}',
