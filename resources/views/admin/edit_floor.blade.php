                        ...
                        <div class="col-lg-12">
                            <div class="card"> 
                                ...
                                <div class="card-header pb-0">
                                    <div class="row">
                                    <div class="col-sm-12">
                                    <h5>Edit Floor details</h5>
                                    </div>
                                    </div>                                    
                                </div>
                                
                                 <div class="card-body admin-form">
                                    <form class="row gx-3" id="editfloor">
                                        <div class="form-group col-md-6 col-sm-6">
                                            <label>Floor <span class="font-danger">*</span></label>
                                                <input type="text" name="floor_name" class="form-control decimal" value="<?php echo $floor->floor_name; ?>" required="">
                                            <input type="hidden" name="catid" class="form-control" value="<?php echo $floor->id; ?>">
                                        </div>
                                    <div class="form-btn">
...
$('#editfloor').submit(function(){
$.ajax({
type: 'POST',
url: '{{url("/api/editfloornow")}}',
...
alert(res.message); 
$(location).attr('href', '{{route('admin.floor')}}');
}
