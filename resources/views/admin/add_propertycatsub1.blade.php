                                ...
                                <div class="card-header pb-0">
                                 ...
                                 <div class="card-body admin-form">
                                    ...
                                    <div class="form-group col-sm-6">
                                            ...
                                            <input type="text" name="propertyname" class="form-control" placeholder="Property Name">
                                    </div>
                                    <div class="form-group col-sm-6">
										...
										<div class="form-group col-sm-4">
                                            ...
                                            <input type="number" maxlength="10" minlength="10" name="ownernumber" class="form-control" placeholder="9876543210" required="">
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Contact 2</label>
                                            <input type="number" maxlength="10" minlength="10" name="contact_two" class="form-control" placeholder="9876543210">
                                        </div>
										<div class="form-group col-sm-4">
										...
										<div class="form-group col-sm-4">
                                            <label><span style="color:red;font-size: 20px;">*</span> Deposite (Months)</label>
                                            <input type="text" name="deposit" class="form-control" placeholder="" required="">
                                        </div>
										<div class="form-group col-sm-4">
										...
										<div class="form-group col-sm-4">
                                            ...
                                            <select name="othercommunity" class="form-select" required="">
                                                 <option>Select...</option>
                                                 <option value="Yes">Yes</option>
                                                 <option value="No">No</option>
                                             </select>
