                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="breadcrumb-item active">Add Executive Name </li>
                                </ol>
                                <!-- Breadcrumb end -->
                        ...
                        <div class="col-lg-12">
                            <div class="card"> 
                                <div class="card-header pb-0">
                                    <h5>Add Executive Name details</h5>
                                </div>
                                 <div class="card-body">

                                
                                    <form class="row gx-3" id="addexecutive">
                                        <div class="form-group col-md-6 col-sm-6">
                                            <label> Name <span class="font-danger">*</span></label>
                                            <input type="text" class="form-control" name="name" placeholder="Executive Name" required>
                                        </div>
...
$('#addexecutive').submit(function(){
$.ajax({
type: 'POST',
url: '{{url("/api/addnewexecutive_name")}}',
//contentType: "application/json",
//dataType: "json",
data: $(this).serialize(),
})
.done(function(res){  
$("#addexecutive")[0].reset();
if(res.status==0){
alert(res.message);
}
else{
alert(res.message);    
$(location).attr('href', '{{route('admin.executive.name')}}');
}
})
.fail(function() { 
