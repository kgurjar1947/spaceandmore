                        ...
                        <div class="col-lg-12">
                            <div class="card"> 
                                ...
                                <div class="card-header pb-0">
                                    <div class="row">
                                    <div class="col-sm-12">
                                    <h5>Edit BHK details</h5>
                                    </div>
                                    </div>                                    
                                </div>
                                
                                 <div class="card-body admin-form">
                                    <form class="row gx-3" id="editbhk">
                                        <div class="form-group col-md-6 col-sm-6">
                                            <label>BHK <span class="font-danger">*</span></label>
                                                <input type="text" name="bhk_name" class="form-control decimal" value="<?php echo $bhk->bhk_name; ?>" required="">
                                            <input type="hidden" name="catid" class="form-control" value="<?php echo $bhk->id; ?>">
                                        </div>
                                    <div class="form-btn">
...
$('#editbhk').submit(function(){
$.ajax({
type: 'POST',
url: '{{url("/api/editbhknow")}}',
...
alert(res.message); 
$(location).attr('href', '{{route('admin.bhk')}}');
}
