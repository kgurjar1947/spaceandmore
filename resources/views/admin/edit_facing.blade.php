                        ...
                        <div class="col-lg-12">
                            <div class="card"> 
                                ...
                                <div class="card-header pb-0">
                                    <div class="row">
                                    <div class="col-sm-12">
                                    <h5>Edit Facing details</h5>
                                    </div>
                                    </div>                                    
                                </div>
                                
                                 <div class="card-body admin-form">
                                    <form class="row gx-3" id="editfacing">
                                        <div class="form-group col-md-6 col-sm-6">
                                            <label>Facing <span class="font-danger">*</span></label>
                                                <input type="text" name="facing_name" class="form-control decimal" value="<?php echo $facing->facing_name; ?>" required="">
                                            <input type="hidden" name="catid" class="form-control" value="<?php echo $facing->id; ?>">
                                        </div>
                                    <div class="form-btn">
...
$('#editfacing').submit(function(){
$.ajax({
type: 'POST',
url: '{{url("/api/editfacingnow")}}',
