...
.page-header .breadcrumb a .fa {
    font-size: 24px !important;
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <h5>Post Property Residential</h5>
                                </div>

                                 <div class="card-body admin-form">
                                    <form class="row gx-3" id="add_residential" method="post" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <div class="form-group col-sm-6">
										...
										<div class="form-group col-sm-4">
                                            ...
                                            <!--<input type="text" id="executivename" name="executivename" class="form-control" placeholder="Name">-->
										...
										<div class="form-group col-sm-4">
                                            ...
                                            <input type="number" name="ownernumber" id="ownernumber" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  maxlength="10"  name="ownernumber" class="form-control" placeholder="9876543210">
										...
										<div class="form-group col-sm-4">
                                            ...
                                            <input type="number" name="supervisornumber" id="supervisornumber" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  maxlength="10" class="form-control" placeholder="98976543210">
           ...
           <!--                                 <input type="text" name="websiteid" id="websiteid" class="form-control" placeholder="123er">-->
										...
										<div class="form-group col-sm-4">
                                            <span style="color:red;font-size: 20px;">*</span><label>AC</label>
          ...
          <!--                              </div>-->
										...
										<div class="form-group col-sm-4">
                                            <label><span style="color:red;font-size: 20px;">*</span>No.of BHK</label>
          ...
          <!--                                      </label>-->
          <!--                                      <label for="chk-ani122">-->
          <!--                                          <input class="checkbox_animated color-4" name="amenities[]" id="chk-ani122" type="checkbox" value="Swimming Pool">Swimming Pool-->
          <!--                                      </label>-->
          <!--                                  </div>-->
          <!--                              </div>-->
									 <div class="input-field col-sm-12 pb-2">
										...
										<div class="form-group col-sm-12">
                                            <label>Property GPS Location<span style="color:red;font-size: 20px;">*</span></label>
