                                    ...
                                    <div class="card all-properties">
                                        <div class="card-body">
                                            <div class="media">
                                                ...
                                                <a href="{{ route('admin.list.property') }}" class="arrow-animated">
                                                    See all properties
                                                    <i data-feather="chevron-right"></i>
                                                </a>
                                                @elseif(auth()->user()->type == 'admin')
                                                 <a href="{{ route('user.admin.list.property') }}" class="arrow-animated">
                                                    See all properties
                                                    <i data-feather="chevron-right"></i>
                                                </a>
                                                @endif
                                            ...
                                            <ul class="light-box">
                                                <li>
                                                    <img src="{{asset('assets/images/svg/icon/sold.png')}}" class="img-fluid" alt="">
                                                    <div>
                                                        <h5>1500</h5>  
                                                ...
                                                <li>     
                                                    <img src="{{asset('assets/images/svg/icon/rent.png')}}" class="img-fluid" alt="">
                                                    <div>                                               
                                                        <h5>380</h5>
                                                ...
                                                <li>      
                                                    <img src="{{asset('assets/images/svg/icon/unlisted.png')}}" class="img-fluid" alt="">
                                                    <div>                                                   
                                                        <h5>240</h5>
                                        ...
                                        <table class="table table-bordernone">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media">
                                                            <img src="{{asset('assets/images/avatar/5.jpg')}}" class="img-fluid" alt="">
                                                            <div class="media-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media">
                                                            <img src="{{asset('assets/images/avatar/6.jpg')}}" class="img-fluid" alt="">
                                                            <div class="media-body">
                                                                <a href="user-profile.html"><h6>Paige Turner</h6></a>
                                                                <span>Pest control</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <a href="user-profile.html"><h6>Mary Goround</h6></a>
                                                                <span>Pumbing</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                        ...
                                        <table class="table table-bordernone">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="media">
                                                            <img src="{{asset('assets/images/svg/icon/pdf.png')}}" class="img-fluid" alt="">
                                                            <div class="media-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media">
                                                            <img src="{{asset('assets/images/svg/icon/microsoft.png')}}" class="img-fluid" alt="">
                                                            <div class="media-body">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="media">
                                                            <img src="{{asset('assets/images/svg/icon/excel.png')}}" class="img-fluid" alt="">
                                                            <div class="media-body">
