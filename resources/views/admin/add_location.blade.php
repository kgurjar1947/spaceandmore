                            ...
                            <div class="card"> 
                                <div class="card-header pb-0">
                                 ...
                                 <div class="card-body">
                                    ...
                                    <form class="row gx-3" id="addlocation">
                                        <div class="form-group col-md-6 col-sm-6">
                                            <label>Location Name <span class="font-danger">*</span></label>
                                            <input type="text" class="form-control" name="location" placeholder="Enter Your Location Name" required>
                                        </div>
