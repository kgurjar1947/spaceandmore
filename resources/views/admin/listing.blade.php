                        ...
                        <div class="">
                            <div class="header_wrap">
                                ...
                                <div class="tb_search col-lg-6" style="display: flex;margin-right: 103px;">
                                     <form style="margin-right:10px;"method="post" action="{{route('admin.export.csv', $segments)}}">
                                         @csrf
                                ...
                                <table class="table table-striped table-class"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="author-box pull-left">
                                                                    @if(auth()->user()->type == 'super_admin')
                                                            ...
                                                            @csrf
                                                                ...
                                                                <input onChange="this.form.submit()" type="checkbox" name="feature"
                                                                    ...
                                                                    value="<?php if($pd->favourites==0){echo '1';}else{echo '0';}?>"
                                                                    <?php if($pd->favourites==1)echo 'checked';?>>
                                                                <label for="status_f<?=$pd->id;?>" class="checktoggle">checkbox</label>
                                                            </form>
                                                                </div></td>
                                            <td>@if($pd->approval == 1) approved @else waiting for approval @endif</td>
                                            <td>{{ date('F d, Y',strtotime($pd->created_at)) }}</td>
