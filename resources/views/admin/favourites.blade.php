                        ...
                        <div class="">
                            <div class="header_wrap">
                                ...
                                <div class="tb_search col-lg-6"style="display: flex;margin-right: 103px;">
                                     <form style="margin-right:10px;"method="post" action="{{route('admin.favourites.csv')}}">
                                         @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="author-box pull-left">
                                                    @if (auth()->user()->type == 'super_admin')
                                                        <form method="post"
                                                            action="{{ route('admin.status.favourites.property') }}">
                                                        @elseif(auth()->user()->type == 'admin')
                                                            <form method="post"
                                                                action="{{ route('user.admin.status.favourites.property') }}">
                                                    @endif
                                                    @csrf
                                                    ...
                                                    <input onChange="this.form.submit()" type="checkbox"
                                                        name="feature" id="status_f<?= $pd['id'] ?>"
                                                        class="check" value="<?php if ($pd['favourites'] == 0) {
                                                            echo '1';
                                                        } else {
                                                            echo '0';
                                                        } ?>"
                                                        <?php if ($pd['favourites'] == 1) {
                                                            echo 'checked';
                                                        } ?>>
                                                    <label for="status_f<?= $pd['id'] ?>"
