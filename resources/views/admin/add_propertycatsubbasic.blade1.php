                                ...
                                <div class="card-header pb-0">
                                 ...
                                 <div class="card-body admin-form">
                                    ...
                                    <div class="form-group col-sm-6">
                                            ...
                                            <input type="text" name="propertyid" class="form-control" value="<?php echo $Property_id?>" placeholder="123476" required="" readonly>
                                    </div>
                                    ...
                                    <div class="input-field col-sm-12 pb-2">
										...
										<div class="form-group col-sm-4">
                                            ...
                                            <input type="number" name="ownernumber" class="form-control" placeholder="9876543210" required="">
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Contact 2</label>
                                            <input type="number" name="contact_two" class="form-control" placeholder="9876543210">
                                        </div>
										<div class="form-group col-sm-4">
                                        ...
                                        <div class="form-group col-sm-4">
                                             <label>Service Charge (Day/Amount)</label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <input type="text" name="totalprice" class="form-control" placeholder="13000">
                                        </div>
										<div class="form-group col-sm-4">
										...
										<div class="form-group col-sm-4">
                                            ...
                                            <input type="number" name="deposit" class="form-control" placeholder="">
                                        </div>
										<div class="form-group col-sm-4">
										...
										<div class="form-group col-sm-4">
                                            ...
                                            <input type="text" name="builtuparea" class="form-control" placeholder="Build up Area..">
                                        </div>
										<div class="form-group col-sm-4">
										...
										<div class="form-group col-sm-4">
                                            <label>Residential Subtype</label>
										...
										<div class="form-group col-sm-4">
                                            <label>Residential Furinished</label>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <label>Geysers</label>
                                            <input type="text" name="geysers" class="form-control" placeholder="No. of Geysers">
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Wardrobes</label>
                                            <input type="text" name="wardrobes" class="form-control" placeholder="Wardrobes">
                                        </div>
										...
										<div class="form-group col-sm-12 mb-4">
                                            ...
                                            <div class="additional-checkbox">
                                                <label for="chk-ani1111">
                                                    <input class="checkbox_animated color-4" name="amenities[]" id="chk-ani1111" type="checkbox" value="Air Conditioning"> Air Conditioning
                                                </label>
												...
												<label for="chk-ani1100">
                                                    <input class="checkbox_animated color-4" name="amenities[]" id="chk-ani1100" type="checkbox" value="Servant Room">Servant Room
                                                </label>
												<label for="chk-ani1200">
                                                    <input class="checkbox_animated color-4" name="amenities[]" id="chk-ani1200" type="checkbox" checked value="Swimming Pool">Swimming Pool
                                                </label>
                                            </div>
                                        </div>
										...
										<div class="form-group col-sm-12">
                                            ...
                                            <input type="text" name="locations" class="form-control" placeholder="iframe">
                                        </div>
