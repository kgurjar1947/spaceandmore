                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="breadcrumb-item active">Add BHK </li>
                                </ol>
                                <!-- Breadcrumb end -->
                        ...
                        <div class="col-lg-12">
                            <div class="card"> 
                                <div class="card-header pb-0">
                                    <h5>Add BHK details</h5>
                                </div>
                                 <div class="card-body">
                                    <form class="row gx-3" id="addbhk">
                                        <div class="form-group col-md-6 col-sm-6">
                                            <label>BHK Name <span class="font-danger">*</span></label>
                                            <input type="text" class="form-control decimal" name="bhk_name" placeholder="Enter Your BHK Name" required>
                                        </div>
...
$('#addbhk').submit(function(){
$.ajax({
type: 'POST',
url: '{{url("/api/addnewbhk")}}',
