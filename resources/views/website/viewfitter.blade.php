                        ...
                        <div class="property-content-side">
                            ...
                            <div class="wrapper grid">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="title-text"><h4><a href="{{url('/')}}/{{$recolink}}/{{ $row->id}}">(<?php echo $row['propertyid']; ?>) {{ $row->propertyname}} <br>{{ $row->pricepersft}} Sq.Ft {{get_sub_cat_name($row->subcategoryid)}}<br/></a></h4></div>
