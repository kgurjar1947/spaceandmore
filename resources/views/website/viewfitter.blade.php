                        ...
                        <div class="default-sidebar property-sidebar">
                            <div class="category-widget sidebar-widget">
                                <div class="widget-title">
                                    <h5>{{get_city_name($property[0]->location ?? null)}}</h5>
                                </div>
                        ...
                        <div class="property-content-side">
                            <div class="item-shorting clearfix">
                                <div class="left-column pull-left">
                                    <h5>Search Results: <span>Showing 1 of {{count($property_main)}} Listings</span></h5>
                                </div>
                                <div class="right-column pull-right clearfix">
                                    <div class="short-box clearfix">
                                        <div class="select-box">
                                            <form action="" method="GET">
                                            <input type="hidden" id="cat" name="cat" value="{{$_GET['cat']}}">
                                            <input type="hidden" id="type" name="type" value="{{$_GET['type']}}">
                                            <input type="hidden" id="leadtype" name="leadtype" value="{{$_GET['leadtype']}}">
                                            <input type="hidden" id="location" name="location" value="{{$_GET['location']}}">
                                            <input type="hidden" id="bhk_name" name="bhk_name" value="{{$_GET['bhk_name']}}">
                                            <input type="hidden" id="facing_name" name="facing_name" value="{{$_GET['facing_name']}}">
                                            <input type="hidden" id="property_id" name="property_id" value="{{$_GET['property_id']}}">
                                            <input type="hidden" id="price_range" name="price_range" value="{{$_GET['price_range']}}">
                            ...
                            <div class="wrapper grid">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="title-text"><h4><a href="{{url('/')}}/{{$recolink}}/{{ $row->id}}">(<?php echo $row['propertyid']; ?>) {{ $row->propertyname}} <br>{{ $row->builtuparea}} Built Up Area, {{get_sub_cat_name($row->subcategoryid)}}<br/></a></h4></div>
                                    ...
                                    <p><?php echo mb_strimwidth($row['description'], 0, 75, '...'); ?>.</p>
