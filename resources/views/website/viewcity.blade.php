       ...
       <!--Page Title-->
        <section class="page-title-two bg-color-1 centred">
            ...
            <div class="auto-container">
                ...
                @if(!empty($property))
                    <h1>{{get_city_name($property[0]->location ?? Request::segment(3))}}</h1>
                    <ul class="bread-crumb clearfix">
                        <li><a href="{{ url('/')}}">Home</a></li>
                        <li>{{get_city_name($property[0]->location ?? Request::segment(3))}} List</li>
                    </ul>
                @endif
                </div>
            </div>
                        ...
                        <div class="default-sidebar property-sidebar">
                            <div class="category-widget sidebar-widget">
                                <div class="widget-title">
                                    <h5 style="display:none !important">{{get_city_name($property[0]->location ?? null)}}</h5>
                            ...
                            <div class="wrapper grid">
                                ...
                                <div class="image-box">
                                    ...
                                    <div class="batch"><i class="icon-11"></i></div>
                                     @php
                                    $name = DB::table('tblcategory')->where('id',$row->categoryid)->first();
                                     @endphp
                                ...
                                <div class="image-box">
                                    ...
                                    <div class="batch"><i class="icon-11"></i></div>
                                    <span class="category">{{ $get_category_name }}</span>
                                </div>
                                <div class="lower-content">
                                    <div class="author-info clearfix">
                                        <div class="author pull-left">
