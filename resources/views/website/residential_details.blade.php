                        ...
                        <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="title-text"><h4><a href="{{url('/')}}/residential_details/{{ $row->id}}"> {{ $row->propertyname}} <br> {{ $row->pricepersft}} Sq.Ft, Appartment <br/><?php echo $row['propertyid']; ?></a></h4></div>
