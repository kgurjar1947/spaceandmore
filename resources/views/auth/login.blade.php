                                ...
                                @csrf
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="email" value="{{old('email')}}" class="form-control @error('email') is-invalid @enderror" placeholder="Enter Email" autocomplete="off" name="email">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" id="pwd-input" class="form-control @error('password') is-invalid @enderror" placeholder="Password" autocomplete="off" name="password">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="{{ route('ForgetPasswordGet') }}" class="font-rubik text-color-2">{{ __('Forgot Your Password?') }}</a>
                                        @endif
                                    </div>
